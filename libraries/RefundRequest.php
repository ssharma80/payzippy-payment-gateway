...
require_once APPPATH."packages/payment/payzippy/libraries/PZ_Config.php";
require_once APPPATH."packages/payment/payzippy/libraries/RefundResponse.php";
...
class RefundRequest
{
    ...
    public function refund()
    {
        ...
        $curl = curl_init();
        //added shantanu - remove below line on prod move - start
//        curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, FALSE);
        //added shantanu - remove below line on prod move - end
